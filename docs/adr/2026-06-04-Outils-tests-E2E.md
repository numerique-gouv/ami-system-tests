...
Nous devons déléguer les tests de recette d'hier à un outil de tests automatisés pour se prémunir contre des régressions.
Les règles de gestion et les use-case se développent sans douleurs aujourd'hui.
La bonne intégration des use cases entre-eux et la maîtrise du déploiement de chaque correctif sur la web app, sur ios et sur android reste un challenge.
...
## Options
[Pour playwright, l'outil et ses variantes ne sont pas satisfaisants](outils%20E2E/playwright/README.md).
...
Dernier point Maestro ne teste que les mobiles, donc la non-régression de l'interface d'administration devrait se faire sur un chrome sous android ou un safari sous ios ?
